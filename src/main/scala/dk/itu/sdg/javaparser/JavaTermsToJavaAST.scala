...
object FinishAST extends JavaTerms
  ...
  */
  ...
  def doit (a : Any, name : String) : Pair[String,Pair[Pair[Int,Int],List[Pair[Pair[Pair[String, Pair[Position, List[Position]]], Pair[Int,List[Pair[Int,Int]]]],Pair[List[Position],Pair[Int,Int]]]]]] = {
    val w = doitHelper(a)
