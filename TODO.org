...
** reveal on pos + 1 if pos + 1 is a whitespace <- PG goes forward all the spaces!
...
** find better heuristic when to update Goal Viewer on Step Until/All: currently every 10th step, should be smarter (take all steps (or time?) into account, etc)
