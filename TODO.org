...
** find better heuristic when to update Goal Viewer on Step Until/All
   currently every 10th step
   take all steps into account, and update n times
   use time, update every full second
